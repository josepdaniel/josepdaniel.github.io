            ...
            <div id="skills">
                ...
                <div class="skillbox">
                    <Paragraph>
                        ...
                        <Pill style={skillStyle}> <p style={{margin: 0}}> Terraform </p> </Pill>
                        ...
                        <Pill style={skillStyle}> <p style={{margin: 0}}> ECS </p> </Pill>
                        <Pill style={skillStyle}> <p style={{margin: 0}}> RDS </p> </Pill>
            ...
            <h1 style={{fontSize: 40}}> Experience </h1>
                ...
                <Paragraph>
                    <div class="experience-entry">
                        <h2> Software Engineer <span style={{color: "#bbbbbb"}}> @  <a href="https://logpoint.com">LogPoint</a></span></h2>
                        <h3> <i> Mar 2022 - Present </i> @ Copenhagen, Denmark </h3>
                        
                        <ul>
                            <li> (mostly) Backend engineer building highly-available systems for a SaaS cyber-security focussed product. </li>
                            <li> Led the product's SaaS transformation by building the first 'cloud-native' service, a multi-tenant alerting engine responsible for processing <strong> 50 million events per day, </strong> and setting the blueprint for future cloud-services. </li>
                            <li> Worked in a functional style using <strong>Scala</strong> and the <strong> TypeLevel ecosystem </strong></li>
                            <li> Tackled deeply technically-challenging problems including building out a query-parser and alerting engine from scratch </li>
                        </ul>
                        <Pill style={skillStyle}> Scala 3 </Pill>
                        <Pill style={skillStyle}> TypeLevel </Pill>
                        <Pill style={skillStyle}> Cats </Pill>
                        <Pill style={skillStyle}> Cats-Effect </Pill>
                ...
                <Paragraph>
                    <div class="experience-entry">
                        ...
                        <h3> <i> Feb 2021 - Feb 2022 </i> @ Sydney, Australia </h3>
                    ...
                    <div class="experience-entry">
                        ...
                        <h3> <i> Jan 2019 - Dec 2020 </i> @ Sydney, Australia </h3>
                        <ul>
                    ...
                    <div class="experience-entry">
                        ...
                        <h3> <i> Jan 2018 - Mar 2018 </i> @ Sydney, Australia </h3>
                        <ul>
                ...
                <Paragraph>
                    <div class="experience-entry">
                        ...
                        <h3> <i> May 2015 - Nov 2018 </i> @ Sydney, Australia </h3>
                        <ul>
